 ...
 * @author whileser
 */
public class estudobczmintface extends javax.swing.JFrame {

    /**
     * Creates new form estudobczmintface
     */
    public estudobczmintface() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Coloca o nome porra");

        Btconf.setText("Clique aqui depois de coloca o nome ali em cima");
        ...
        jLabel1.setText("Coloque o teu nome ai em baixo onde escreve.");
    ...
    private void BtconfActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtconfActionPerformed
        ...
        Metodo exe = new Metodo();
        exe.recebeParametros(cnome.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(estudobczmintface.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new estudobczmintface().setVisible(true);
            }
        });
    }
